...
class MixedLinks(models.Model):
    ...
    link_pages = fields.Many2one('website.page', string='Page Name', domain=[
...
class ContentSectionGroup(models.Model):
    ...
    content_html = fields.Html(string='Content HTML')
    megamenu_id = fields.Many2one('megamenu.content', string='Mega Menu')
...
class MegamenuContent(models.Model):
    ...
    label_text = fields.Char(domain=[('has_label','=',True)])
    label_bg_color = fields.Char(string="Label bgcolor",domain=[('has_label','=',True)])
    label_text_color = fields.Char(string="Label text color",domain=[('has_label','=',True)])
    ...
    header_content = fields.Html(string='Header Content')
    footer_content = fields.Html(string='Footer Content')
    ...
    menu_content = fields.Html(string='Content')
